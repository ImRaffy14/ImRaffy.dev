...
function Skills ({isLight}){
    return (
        <section id="section2">
        <div className={`h-[3000px] w-full ${isLight ? `bg-gradient-to-b from-gray-300 to-slate-200`:`bg-gradient-to-b from-gray-800 to-neutral-800`} text-white`}>
          <div className="max-w-screen-xl mx-auto flex flex-col items-center lg:items-start justify-center h-[450px] px-4">
